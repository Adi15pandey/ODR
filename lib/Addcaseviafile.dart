...
class _AddCaseFormState extends State<AddCaseForm> {
  ...
  void fetchClients() async {
    try {
      final response = await _dio.get('http://192.168.0.109:4001/api/client/all');
      setState(() {
    ...
    if (_formKey.currentState!.validate()) {
      try {
        ...
        final caseData = {
          ...
          "clientName": clientName, // Ensure this is not empty
        ...
        var request = http.Request(
          'POST',
          Uri.parse('http://192.168.0.109:4001/api/cases/addcase'),
        );
                ...
                _buildDropdown(
                  ...
                  _selectedClientId,
                    ...
                    setState(() {
                      ...
                      _selectedRespondentId = null; // Reset respondent
                    });
                  },
                ),
                TextFormField(

...
class _AdminClientState extends State<AdminClient> {
  ...
  Future<void> fetchClientUid() async {
    final response = await http.get(
        Uri.parse('http://192.168.1.12:4001/api//autouid/client'));
  ...
  Future<void> fetchClients() async {
    const String url = "http://192.168.1.12:4001/api/client/all";
    try {
  ...
  Future<void> updateClient(String id, String name, String contactNo,
    ...
    final String url = "http://192.168.1.12:4001/api/client/update/$id";
    try {

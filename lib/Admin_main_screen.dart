...
class ArbitratorMainScreen extends StatefulWidget {
  const ArbitratorMainScreen({super.key});

  @override
  State<ArbitratorMainScreen> createState() => _ArbitratorMainScreenState();
}

class _ArbitratorMainScreenState extends State<ArbitratorMainScreen> {
  ...
  Future<void> _fetchCounts() async {
    final url = 'http://192.168.1.12:4001/api/global/arbitrator/counts';
  ...
  Future<void> _fetchCaseCompletedData() async {
    final url = 'http://192.168.1.12:4001/api/cases/chartdata/arbitrator';
  ...
  Future<void> _fetchMeetingData() async {
    final url = 'http://192.168.1.12:4001/api/webex/recent-meetings/arbitrator';
    final headers = {
      'token': '$token',
    };
  ...
  Future<void> _fetchRecentMeetingData() async {
    final url = 'http://192.168.1.12:4001/api/webex/recent-fullMeetingDataWithCaseDetails/arbitrator'; // Your API endpoint for recent meetings
    final headers = {
      'token': '$token',
    };
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              _buildDrawerItem(
                ...
                text: 'Cases',
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => Arbitratorcases()));
                  // Navigator.pop(context);
                },
              ),
              _buildDrawerItem(

...
class _ClientMainScreenState extends State<ClientMainScreen> {
  ...
  Future<void> _fetchCounts() async {
    final url = 'http://192.168.1.12:4001/api/global/client/counts';
  ...
  Future<void> _fetchCaseCompletedData() async {
    final url = 'http://192.168.1.12:4001/api/cases/chartdata/client';
  ...
  Future<void> _fetchMeetingData() async {
    final url = 'http://192.168.1.12:4001/api/webex/recent-meetings/client';
    final headers = {
      'token': '$token',
    };
  ...
  Future<void> _fetchRecentMeetingData() async {
    final url = 'http://192.168.1.12:4001/api/webex/recent-fullMeetingDataWithCaseDetails'; // Your API endpoint for recent meetings
    final headers = {
      'token': '$token',
    };

...
class _ForgotPasswordState extends State<ForgotPassword> {
  ...
  Future<void> _sendOtp() async {
    ...
    final url = Uri.parse('${GlobalService.baseUrl}/api/resetpassword/userexists');
    try {
  ...
  Future<void> _verifyOtp() async {
    ...
    final url = Uri.parse('${GlobalService.baseUrl}/api/resetpassword/verifyotp');
    try {
      final response = await http.post(
        url,
        body: json.encode({
  ...
  Future<void> _resetPassword() async {
    ...
    final url = Uri.parse('${GlobalService.baseUrl}/api/resetpassword/updatepassword');
    try {
